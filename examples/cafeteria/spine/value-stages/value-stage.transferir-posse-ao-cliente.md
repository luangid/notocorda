...
certo — por entrega, retirada no balcão, coleta em um ponto de
encontro ou qualquer outro meio.
...
A capacidade que a habilita — [[capability.garantir-transferencia-correta|Garantir transferência correta]]
— também não possui nenhuma realização documentada em nenhum cenário.
Lacuna intencional, dupla e estrutural (ver diagnósticos do grafo).
